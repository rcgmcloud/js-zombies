...
Player.prototype.checkPack = function() {
  console.log(this.getPack()[0] + " " + this.getPack()[1] + " " + this.getPack()[2]);
};
...
//     console.log("The pack is already full so the item could not be stored.")
//     return false;
//   }
//   this.getPack().push(item);
//   console.log(this.getPack());
//   console.log(this.name + " added " + item.name + " to their pack.");
//   return true;
// }
...
Player.prototype.discardItem = function(item) {
  console.log(this.getPack().indexOf(item));
...
Player.prototype.equip = function(itemToEquip) {
  ...
  var packNum = pack.indexOf(itemToEquip);
  ...
  //put intitial equip into pack
  pack.push(this.equipped);
  //equips
  this.equipped = pack[packNum];
  //removes from pack
  pack.splice(pack[packNum], 1);
  return true;
};
...
Player.prototype.eat = function(itemToEat) {
  ...
  this.getPack().splice(this.getPack()[this.getPack().indexOf(itemToEat)], 1);
  return true;
};
